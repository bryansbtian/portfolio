...
import profilePic from "../assets/bryanProfile.jpeg"
    ...
    <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-centers lg:items-start">
                ...
                initial="hidden"
                animate="visible"
                className="pb-16 text-6xl font-thin trackting-tight lg:mt-16 lg:text-8xl">Bryan Susanto
                </motion.h1>
                <motion.span
                ...
                bg-clip-text text-3xl tracking-tight text-transparent">Rising Junior
                </motion.span>
                <motion.p 
