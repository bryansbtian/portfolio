...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    company: "Trend AI",
    description: `Engineered cloud telemetry and remote diagnostics workflows for enterprise security appliances, enabling 15-minute collection of usage, system health, feature adoption, and connectivity signals into AWS-backed analytics pipelines. Built an MCP-based AI interface for natural-language investigation and implemented proactive support automation with secure remote diagnostics, rule-based health alerts, deduplication, and Jira routing. Modernized legacy Windows security filter authoring and rule-conversion tools into a cross-platform React/Spring Boot application, preserving validation, package compatibility, CLI workflows, and third-party rule conversion.`,
    technologies: [
      "Go",
      "Java",
      "Spring Boot",
